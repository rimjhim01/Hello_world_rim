...
table_df["Absolute Change"] = (table_df["2022"] - table_df["2000"]).round(2)
table_df

# Calculate relative change as the absolute change divided by the 2000 emissions, then multiplied by 100
table_df["Relative Change"] = (table_df["Absolute Change"] / table_df["2000"] *100).round(2)
table_df
...
selected_countries = ["Austria", "UAE", "Angola", "Argentina", "Andorra"]
emissions_long = emissions_long[emissions_long["country"].isin(selected_countries)]
emissions_long

# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(emissions_long, x="year", y="emissions", color="country")
fig_chart
